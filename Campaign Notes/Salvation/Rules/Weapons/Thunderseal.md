...
## Item 1
 ...
 ---
==Unique== ==Exotic== ==Artifact== ==Magical==

**Price** X gp
**Usage** held in 1 hand; **Bulk** 1
**Damage** 1d6 **Critical** 19-20/x2 **Type** Slashing (Edge), Bludgeoning (Hilt)
**Type** Melee; **Category** One-Handed; **Proficiency** Exotic
...
# Actions
---
**Electrifying Presence** `[free-action]`:
	Use one charge of the sword to enable your next round of attacks to deal electric damage instead of slashing

**Mark**\* `[one-action]`: Mark an enemy with hint of electricity. Any attacks that you deal with have a +2 to hit and will deal electric damage. Once you mark this creature once, you can tell where this creature is within 15 ft of you and you sense its presence within 45 ft of you

**Knock Out** `[one-action]`: Simple Hilt attack to allow for the damage type to be bludgeoning and is also non lethal, deals the same amount of damage.

**Dire Eclat** `[one-action]`: *Energy flows through the weapon everyone notices the crackling of electricity* 
...
**Stun Edge** `[two-actions]`: *The electricity flowing through the sword needs to get out, so you tilt it giving it direction*
...
**Ride the Lightning**\* `[three-actions]`: *Charging up the blade you channel a small spark of creation and become an unstoppable force*
	Move forward in a straight line 15 ft dealing 2d6 Electric Damage and pushing everyone away 5ft. This consumes 3 charges

**Dragon Install**\* `[reaction]`: *Consumed by the spark of creation the Lightning envelops you giving you breath as you fall in battle*
